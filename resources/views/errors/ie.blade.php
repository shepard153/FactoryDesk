...
<html>
  ...
  <body class="text-center bg-dark">
    <div class="col">
        ...
        <h3 style="color:white;">Strona nie wspiera przeglądarki Internet Explorer. Aby przejść dalej sugerujemy skorzystanie z innych przeglądarek:</h3><br/>
        ...
        <a href="microsoft-edge:http://10.39.15.194:8081/test/login.php"><img class="mb-4" src="{{ asset('public/img/edge.png') }}" alt="" width="320" height="110"></a>
    </div>
  </body>
</html>